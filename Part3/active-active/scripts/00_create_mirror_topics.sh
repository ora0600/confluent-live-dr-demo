...
while read i; do
  if [[ -n "$i" ]]; then
    confluent kafka mirror create mirror-${i} --source-topic ${i} --cluster $cluster_destination_id --environment $destination_envid --link bidirectional
    confluent kafka topic create ${i} --cluster $cluster_destination_id --environment $destination_envid
    confluent kafka mirror create mirror-${i} --source-topic ${i} --cluster $cluster_source_id --environment $source_envid --link bidirectional
    ...
    confluent kafka acl create --allow --service-account $consumer_said --operations read --consumer-group cmgroup-primary --cluster $cluster_source_id --environment $source_envid
    confluent kafka acl create --allow --service-account $consumer_said --operations read --consumer-group cmgroup-secondary --cluster $cluster_source_id --environment $source_envid
    confluent kafka acl create --allow --service-account $consumer_said --operations read --consumer-group cmgroup-secondary --cluster $cluster_destination_id --environment $destination_envid
    confluent kafka acl create --allow --service-account $consumer_said --operations read --consumer-group cmgroup-primary --cluster $cluster_destination_id --environment $destination_envid
