...
export consumerid=${8}
export producerid=${9}
export source_envid=${10}
export cluster_source_id=${11}
export destination_envid=${12}
export cluster_destination_id=${13}
...
export cluster_source_id=$cluster_source_id
export destination_envid=$destination_envid
export cluster_destination_id=$cluster_destination_id" > ./env-destination
